...
<body>
	...
	<div class="jumbotron">
		<div class="container">
			<div class="panel panel-primary">
				...
				<form id="stepForm" action="./installWizard.do" method="post"
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label for="databaseJndi"
								class="col-sm-offset-2 col-sm-2 control-label">数据库JNDI:</label>
							<div class="col-sm-4">
								<input id="databaseJndi" class="form-control" type="text"
									name="databaseJndi"
									value="<c:out value="${info.databaseJndi}" />">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<input type="hidden" name="actionType"> <input
								type="hidden" name="code" value="installStep_2_2">
						</div>
					</div>
	...
	数据库连接配置
	<br>
	数据库JNDI：<input type="text" name="databaseJndi" value="<c:out value="${info.databaseJndi}" />">
	<input type="button" value="测试连接">
	<p>
	<input type="hidden" name="actionType">
	<input type="hidden" name="code" value="installStep_2_2">
